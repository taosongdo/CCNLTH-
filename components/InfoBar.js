...
const InfoBar = (props) => {
    return (
        <View style={[Styles.marginBottom10, props.backgroundColor ? { backgroundColor: props.backgroundColor } : Styles.bgColorBFDBFE, Styles.w100per, Styles.borderRadius10, Styles.p10]}>
